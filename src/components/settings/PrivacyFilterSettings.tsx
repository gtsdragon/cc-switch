    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="privacy-enabled">
                {t("privacyFilter.enableLabel")}
              </Label>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setConfig({
                  ...config,
                  port: parseInt(e.target.value) || 18088,
                })
              }
              className="max-w-xs"
            />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t("privacyFilter.testDescription")}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="test-input">
              {t("privacyFilter.testInputLabel")}
            </Label>
            <Textarea
              id="test-input"
              value={testText}
